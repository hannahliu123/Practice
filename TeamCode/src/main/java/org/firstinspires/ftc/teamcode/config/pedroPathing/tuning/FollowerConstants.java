...
public class FollowerConstants {
    ...
    private static double xMovement = 75.52959063138782;
    private static double yMovement = 56.55835747255511;
    ...
    public static double forwardZeroPowerAcceleration = -36.05455726394684;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -65.96487705834053;
